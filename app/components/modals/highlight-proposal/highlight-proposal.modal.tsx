...
export const HighlightProposalModal = ({
  ...
  const handleDisputeWorkProposal = async () => {
    try {
      ...
      handleShowFeedbackModal(true, {
        message: "Your proposal disputed. Thank you!",
        type: "success",
      });
    } catch (error: any) {
      handleShowFeedbackModal(true, {
            ...
            <div className="flex flex-col p-6 gap-3">
                  ...
                  <div className="flex items-center gap-2 mt-4">
                    ...
                    <span className="text-white text-lg">
                      ...
                      <b>
                        (
                        {reachedDenyVotesForFinalizing
                          ? "Reached Deny Final Votes🟥"
                          : "Not Reached Deny Final Votes⏳"}
                        )
                      </b>
                    </span>
                  </div>
              ...
              {!canStartWork && (
                <>
                  ...
                  {isArbiter && !isAproved && (
                    <ArbiterVoteOptions proposalId={proposalData.id} />
                  )}
                </>
              )}
              {canStartWork && (
